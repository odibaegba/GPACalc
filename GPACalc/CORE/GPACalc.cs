...
namespace GPACalc.CORE
{
    public class GradeCalculations
    {
        ...
        //creates a construcctor that takes course code, course unit , course score and number of courses from the inpuntCollectors class 
        ...
        public void Calculator()
        {
            ...
            for (int j = 0; j < NumberOfCourses; j++)
            {
                ...
                else if(CourseScores >= 50)
                {
                    Course_Grade.Add("C");
                    Remark.Add("Good");
                    Grade_Unit.Add("3");
                }
                else if(CourseScores >= 45)
                {
                    Course_Grade.Add("D");
                    Remark.Add("Fair");
                    Grade_Unit.Add("2");
                }
                else if(CourseScores >= 40)
                {
                    Course_Grade.Add("E");
                    Remark.Add("Pass");
                    Grade_Unit.Add("1");
            ...
            //calculates and add Course_weightPoint and add to course_weightPoint arraylist
